      ...
      <Fragment>
        <section id='about' className={styles.about}>
          <div className="container about__container">
            ...
            <div className={styles['about__container--request']}>
              <h2 className={styles['about__container--request--title']}>Why work with us</h2>
          ...
          <div className={`container-fluid ${styles['about__container--info']}`}>
            <div className={`${styles['about__container--info2 ']} container`}>
              <div className="about__container--info--left">
                <img src={image2} alt="image" />
              </div>
              <div className={styles['about__container--info--right']}>
                <p className={styles['info--right--text1']}>Lorem ipsum</p>
                <h2 className={styles['info--right--title']}>Lorem Ipsum is simply dummy text of the printing and typesetting industry. </h2>

                <p className={styles['info--right--text2']}>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries,</p>
              </div>
            </div>
          </div>

          <div className="container about__container">
            <div className={styles['about__container--team']}>
              <h2 className={styles['about__container--team--title']}>Our Team</h2>
            ...
            <div className={styles['about__container--call']}>
              <h2 className={styles['about__container--call--title']}>Lorem ipsum</h2>
              <p className={styles['about__container--call-text']}>Lorem Ipsum is simply dummy text of the printing and typesetting industry. </p>
